    ...
    return (
        <div className="flex justify-center items-center py-10">
            <div className="relative shadow-2xl w-[30rem] px-14 py-5 bg-gray-100 rounded-md">
                ...
                <h1 className="font-bold text-3xl my-10 py-1 text-center tracking-wider select-none">Login Form</h1>
                <form
                    className="text-lg"
                    method="post"
                    onSubmit={(e) => submit(e)}>
                    ...
                    <div className="flex justify-center">
                        <button className="border rounded-lg px-4 py-1 my-5 text-white bg-gradient-to-r from-red-300 to-yellow-500 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 select-none" type="submit">Login</button>
                    </div>
                </form>
            </div>
        </div>
